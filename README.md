...
找到个地方直接下载 mini 版本的安装包：[https://chromium.cypress.io/](https://chromium.cypress.io/)
...
上面问答采纳的那条回复里的检索页面已经下线，但是其它回答里的地址倒是可以直接用：[https://vikyd.github.io/download-chromium-history-version/](https://vikyd.github.io/download-chromium-history-version/)
